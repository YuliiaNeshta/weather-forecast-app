...
export const Table: FC<TableProps> = ({ tableData = [], deleteLocation, isLoading }) => {
  ...
  /**
   * Смотри, у тебя функция принимает число, возвращает строку, при то еще и с символом градусов.
   * В названии говориться о конвертировании, но ни слова о форматировании в строку с символом градусов.
   *
   * Ну и конвертирование в градусы Цельсия никак не должно лежать в компоненте таблицы. Это просто не относится к ней.
   * Можешь создавать парочку по типу utils и складывать подобные приколы туда.
   * */
